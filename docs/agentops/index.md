...
> Generated at: 2026-05-13T06:56:58.631Z | Total flows: 18
...
| ⚠ FEAT-016 | ✓      | ui-v1-design-system — design-system overhaul, átomos shared, token coverage ≥95%     | escalated      | escalated | 81         | 42  | 1.93    | 0.0%  | $299.8910 | $7.1403  | 2026-05-12 |
| ⚠ FEAT-017 | ✓      | baseline-grid-alignment — rítmica vertical 24px como contrato do design system       | escalated      | escalated | 10         | 52  | 0.19    | 0.0%  | $163.5999 | $3.1462  | 2026-05-12 |
...
| ✓ FEAT-019 | ✓      | drag-reorder — reordenação drag-and-drop + teclado em Prioridades e Notas            | done           | done      | 65         | 26  | 2.50    | 0.0%  | $761.6940 | $29.2959 | 2026-05-13 |
| … FEAT-020 | ✓      | sticky-note — Post-it global com aba colada, rich text e persistência servidor       | implementation | running   | 0          | 26  | —       | —     | —         | —        | 2026-05-13 |

_Compl. legend:_ ✓ standard · ◐ pré-padrão (excluído de trends/health) · ⊘ pm-bypass (excluído de trends/health)

## Trends

- Dispatches/AC: FEAT-018=2.94 → FEAT-019=2.50 (-15.1%)
- Dev task success rate: FEAT-018=100.0% → FEAT-019=94.4% (-5.6%)
- Cost per AC: FEAT-007=$0.6571 → FEAT-019=$29.2959 (+4358.2%)
