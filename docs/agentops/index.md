...
> Generated at: 2026-05-14T03:10:15.087Z | Total flows: 19
...
| ⚠ FEAT-017 | ✓      | baseline-grid-alignment — rítmica vertical 24px como contrato do design system       | escalated | escalated | 13         | 52  | 0.25    | 0.0%  | $185.2970 | $3.5634 | 2026-05-12 |
...
| ✓ FEAT-021 | ✓      | sticky-note — Post-its multi-cor com drag livre e proporção post-it real             | done      | done      | 74         | 36  | 2.06    | 0.0%  | $18.3105  | $0.5086 | 2026-05-13 |

_Compl. legend:_ ✓ standard · ◐ pré-padrão (excluído de trends/health) · ⊘ pm-bypass (excluído de trends/health)

## Trends

- Dispatches/AC: FEAT-020=1.23 → FEAT-021=2.06 (+67.0%)
- Dev task success rate: FEAT-020=93.8% → FEAT-021=100.0% (+6.7%)
- Cost per AC: FEAT-007=$0.6571 → FEAT-021=$0.5086 (-22.6%)
