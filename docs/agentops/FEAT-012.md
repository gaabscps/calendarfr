...
| ------------ | --------------- | ------ | ---- | -------- | --------- | -------- | --------------------------------------------------------------------------------- |
| pm-orches... | pm-orchestrator | done   | —    | 68062724 | $748.6900 | 595m 18s | PM/orchestrator session (Stop hook): 466 turns                                    |
...
| FEAT-012-... | logic-reviewer  | done   | —    | 79553    | $0.5250   | 2m 34s   | L1: 4 majors (isAnimating guard ausente, animationend ausente, 2 test gaps) +...  |
